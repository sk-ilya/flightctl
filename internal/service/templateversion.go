...
func (h *ServiceHandler) ListTemplateVersions(ctx context.Context, orgId uuid.UUID, fleet string, params domain.ResourceListParams) (*domain.ResourceList[domain.TemplateVersion], domain.Status) {
	var err error
