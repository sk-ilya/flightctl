...
func (h *ServiceHandler) ListResourceSyncs(ctx context.Context, orgId uuid.UUID, params domain.ResourceListParams) (*domain.ResourceList[domain.ResourceSync], domain.Status) {
